...
<div class="container" id="home-main">
  <div class="row" style="margin-top:7%;">
    <div calss="col-sm-12">
    <div class="col-sm-6">
        <h1><p style="width:75%;">Tu souhaites plus d’informations ? Contactes-nous,</p><p> Fais-nous confiance !</p></h1>
        <div class="sepNoir" style="background-color:white;"></div>
      </div>
      <div class="col-sm-6">
   ...
   <fieldset>
       ...
       <textarea class="form-control" type="text" name="message" id="message" placeholder="Votre message"></textarea><br>
              ...
              <br>
              <button type="submit" name="form_contact" class="button_contact" href="#" style="margin-left:27%;font-size: 1em; text-decoration:none;" onclick="alert('Formulaire envoyé merci');">Soumettre</button>
          </form>
        <?php
...
<div class="grosconteneur" style="background: white;" >
...
<div class="container">
    <div class="row">
        <h1 class="titre-contact">Retrouves-nous via Google Map</h1>
        <hr>
