...
<div id="myCarousel" class="carousel slide swag" style="margin-left:0;">
    <div class="carousel-inner" id="innerDeux">
       ...
       $reponse= $bdd->query('SELECT * FROM proposer_formations ORDER BY id DESC LIMIT 0,3');
...
?>
      ...
      <div class="item" id="pageDeux">      
            <?php 
        //recup du contenus des tables articles
       $reponse= $bdd->query('SELECT * FROM proposer_formations ORDER BY id DESC LIMIT 4,7');
        //affichage des elements
        while($donnees = $reponse->fetch())
        {
?>
...
?>
        ...
        <div class="item" id="pageTrois">      
            <?php 
        //recup du contenus des tables articles
       $reponse= $bdd->query('SELECT * FROM proposer_formations ORDER BY id DESC LIMIT 8,11');
        //affichage des elements
        while($donnees = $reponse->fetch())
        {
?>
...
?>
        ...
        <div class="item" id="pageQuatre">      
            <?php 
        //recup du contenus des tables articles
       $reponse= $bdd->query('SELECT * FROM proposer_formations ORDER BY id DESC LIMIT 12,15');
        //affichage des elements
        while($donnees = $reponse->fetch())
        {
?>
